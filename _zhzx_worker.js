...
export default {
  async fetch(request, env) {
    ...
    async function getVerificationSuccessMessage() {
      ...
      const response = await fetch('https://raw.githubusercontent.com/panyt0615/ctt/refs/heads/main/CFTeleTrans/zhzx_start.md');
    ...
    async function getNotificationContent() {
      const response = await fetch('https://raw.githubusercontent.com/panyt0615/ctt/refs/heads/main/CFTeleTrans/notification.md');
